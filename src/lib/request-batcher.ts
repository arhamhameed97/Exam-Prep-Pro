...
class RequestBatcher {
  ...
  async addRequest(request: TestGenerationRequest): Promise<any[]> {
...
export async function generateTestQuestionsBatched(request: TestGenerationRequest): Promise<any[]> {
